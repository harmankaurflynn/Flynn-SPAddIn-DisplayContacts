...
export class ContactDetailsComponent implements OnInit {
  ...
  public contactsOthers: Contacts[];
  ...
  getContactsforSelectedCountry() {
    ...
    this.contactsOthers = this.contactsByCountry.filter(contact => (contact.jobTitle != "Safety Director" && contact.jobTitle != "Regional Health & Safety Manager" && contact.jobTitle != "Health & Safety Specialist"))
